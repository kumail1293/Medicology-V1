...
/** Standard closing row: social icons + footer + unsubscribe. */
const CLOSE = [SOCIALS, FOOTER, UNSUBSCRIBE];
...
const TEMPLATES: SeedTemplate[] = [
  {
    ...
    senderEmail: 'no-reply@medicology.net',
  ...
  },
  {
    ...
    senderName: '{{platform.name}}',
    senderEmail: 'billing@medicology.net',
    audience: 'purchasers',
  ...
  },
  {
    ...
    senderName: '{{platform.name}} Security',
    senderEmail: 'security@medicology.net',
  ...
  },
  {
    ...
    senderEmail: 'admin@medicology.net',
  ...
  },
  {
    ...
    senderName: '{{platform.name}}',
    senderEmail: 'offers@medicology.net',
